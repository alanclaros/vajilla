...
function sendFormCajaEgreso(operation, message) {
	...
	switch (operation) {
		...
		// 		//set data modal
		// 		modalSetParameters('success', 'center', 'Cajas Egresos!', 'Esta seguro de querer guardar estos datos?', 'Cancelar', 'Guardar');
		// 		modalF.modal();
		// 	}
		// 	else {
		// 		//set data modal
...
// function mandarFormularioCajaEgreso(operation, operation2, formulario, add_button, button_cancel) {
// 	if (verifyForm()) {
// 		document.forms[formulario].elements[add_button].disabled = true;
// 		document.forms[formulario].elements[button_cancel].disabled = true;
...
// function confirmarAnularCajaEgreso() {
...
// 	if (confirm('Esta seguro de querer anular este egreso?')) {
// 		token_operation = document.forms['form_operation'].elements['csrfmiddlewaretoken'].value;
