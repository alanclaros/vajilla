...
def myFirstPage(canvas, doc):
    ...
    datosReporte['titulo'] = 'Egresos de Caja ' + DATO_CAJA
...
def rptEgresosCaja(buffer_pdf, usuario, ciudad_id, sucursal_id, caja_id, fecha_ini, fecha_fin, anulados):
    ...
    datos_reporte = reporte_controller.datos_egreso_caja(usuario, ciudad_id, sucursal_id, caja_id, fecha_ini, fecha_fin, anulados)
    # print(datos_reporte)
